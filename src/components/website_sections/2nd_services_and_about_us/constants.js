...
export const values = [
    ...
    {   id: 3,  symbol: giftboxLogo, title: "الثقة",
        desc: ["نبنى علاقتنا مع العملاء على الثقة والشفافية، وهذا هو أساس نجاحنا واستمرارنا"]
    }, 
    
    {   id: 4,   symbol: wifiLogo,   title: "التنوع",
        desc: ["نوفر مجموعة واسعة من الخيارات العقارية التي تلبي مختلف الأذواق والاحتياجات    "]
    }
];